...
const recentlyViewdSchema = new mongoose.Schema({
...
recentlyViewdSchema.set('toJSON', { virtuals: true });

export const RecentlyViewd = mongoose.model('RecentlyViewd', recentlyViewdSchema);
